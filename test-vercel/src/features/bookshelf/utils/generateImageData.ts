...
export const generateImageData = async (isbn13or10: string, imageType: 't' | 's' | 'm' | 'l') => {
  const genImgUrl = generateAmazonImageUrl(isbn13or10, imageType)
  const noImgUrl = 'https://placehold.jp/120/aaaaaa/ffffff/500x720.jpg?text=No%0AImage'
